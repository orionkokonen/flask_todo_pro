...
A モデル全体の地図(User/Team/Project/Task/SubTask の関係) 「アプリの構造を把握している」証明
B 多対多と中間テーブル(質問1・2) SQLAlchemyで何を書けるかの証明
C can_access() によるモデル層の認可 このアプリ独自の設計判断(他と差別化できる唯一の話題)
...
- ユニット2
  ...
  cascade="all, delete-orphan" → 同上 -ユニット3
